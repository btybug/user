                ...
                <div id="myTabContent" class="tab-content col-md-9">
                    <div class="tab animated" id="permission">
                        <div class="user-profile-content">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td>{!! $role->slug !!}</td>
                                                <td>
                                                    <span data-url="{!! URL::to('/admin/users/role/'.$role->id.'/edit') !!}"
                                                          class='btn btn-xs btn-default' data-name="{{ $role->name }}"
                                                          onclick="editRole(this)"> <i
                                                                class='fa fa-edit'></i> Edit</span>

                                                    @if($role->id != \App\Modules\Users\User::ROLE_STUFF && $role->id !=
                                                    \App\Modules\Users\User::ROLE_ADMIN)
                                                    {!! Form::open(['id'=> 'deleteRole'.$role->id,'method' =>
                                                    'DELETE','route' => 'admin.users.role.destroy','class' =>
                                                    'form-inline']) !!}
                                                    <input type="hidden" value="{{ $role->id }}" name="id"
                                                           class="del-row-id"/>
                                                    <span class="btn btn-danger btn-xs del-role-icon"><i
                            ...
                            {!! Form::open(['route' => 'admin.users.assignPermissions', 'role' => 'form',
                            'class'=>'permission-form']) !!}
                            <div class="col-md-12 permissions-list">
                                @include('users::forms._permissions_form')
                            </div>
                            {!! Form::submit(isset($buttonText) ? $buttonText : 'Save Permission',['class' => 'btn
                    ...
                    <div class="tab-pane animated fadeInRight" id="social_login">--}}
                        ...
                        <div class="user-profile-content">--}}
                            ...
                            <div class="row">--}}
                                {{--
                                <div class="col-sm-12">--}}
                                    {{--{!! Form::open(['route' => 'configuration.socialLoginStore','role' => 'form',
                                    'class'=>'social-login-form form-horizontal']) !!}--}}
